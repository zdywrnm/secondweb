...
class AxiosGuestbookManager {
    ...
    async handleSubmit() {
        ...
        try {
            ...
            const messageData = {
                nickname: formData.get('name') + ' - ' + formData.get('className'),
                content: formData.get('content'),
                email: formData.get('studentId') + '@zwu.edu.cn', // 使用学号+学校域名作为email
                ...
                <div style="background: var(--bg-primary); border-radius: var(--radius-lg); padding: 20px; margin-bottom: 20px; box-shadow: var(--shadow-sm); transition: transform 0.2s, box-shadow 0.2s;">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 15px;">
                        <div style="display: flex; align-items: center;">
                            ...
                            <div>
                                <h4 style="margin: 0; font-size: 1.1rem; color: var(--text-primary);">${this.escapeHtml(message.nickname)}</h4>
